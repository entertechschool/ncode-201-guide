# 📚 Code 201 — Fundamentals of Software Development — Hub del Instructor
...
| 📦 | **Proyecto Integrador** | Estudiante (referencia) | Documento oficial del proyecto del módulo con historias de usuario, criterios y rúbrica. |
...
| Clase | Tema | Lab | Tipo |
|-------|------|-----|------|
| 01 | HTML5 Semántico y Accesibilidad | [Lab 01](https://entertechschool.github.io/ncode-201-guide/curriculum/class-01/lab/){:target="_blank"} | Regular |
| 02 | CSS Layout con Flexbox | [Lab 02](https://entertechschool.github.io/ncode-201-guide/curriculum/class-02/lab/){:target="_blank"} | Regular |
| 03 | CSS Grid Layout | [Lab 03](https://entertechschool.github.io/ncode-201-guide/curriculum/class-03/lab/){:target="_blank"} | Regular |
...
*Code 201 — Fundamentals of Software Development · EnterTechSchool*
