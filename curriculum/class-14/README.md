...
La pieza nueva es la **delegación de eventos**: en lugar de enganchar un listener a cada botón (que desaparece cada vez que re-renderizas), pones **uno solo** en el contenedor y, según dónde se hizo clic, decides qué hacer.
...
4. **Filtrarás por hashtag** - El buscador reacciona y muestra solo las coincidencias.
...
4. **Filtrar** la lista por hashtag derivando la vista del estado, sin mutar el estado original.
