...
"HU1: descubren la asincronía (orden 1-2-3 en consola → fetch da una promesa).
 ...
 HU4: con Promise.all llenan la rejilla (un array de nombres), y reconectan el buscador.
...
### Dinámica 3: "¿uno o varios?" (en HU4)
...
| ~95' | HU4 | La rejilla muestra los 6 Pokémon de la API (array de nombres); el buscador filtra esa rejilla. |
...
- **Terminan antes:** logro del spinner animado o de manejar un ID inexistente.
