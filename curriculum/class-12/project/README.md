...
Este proyecto consolida todo lo aprendido durante el **Módulo 3: Aplicaciones Web con Objetos**. El objetivo es que cada estudiante desarrolle un editor avanzado de Markdown en tiempo real, integrando conceptos de manipulación del DOM, funciones avanzadas, manejo de eventos básicos y gestión efectiva de excepciones (manejo de errores), para generar una herramienta interactiva y funcional.

> ⏳ Cada estudiante presentará su proyecto en una **demostración en vivo de máximo 10 minutos** ante el instructor y sus compañeros, explicando sus **decisiones técnicas clave**.
...
| **Argumentación Técnica** |Justificación técnica clara sobre:- Decisiones en la estructura y manipulación del DOM.- Uso específico y justificado de funciones, callbacks y eventos.- Beneficios prácticos obtenidos al manejar errores y excepciones para garantizar robustez frente a otras opciones. | **35 pts** |
